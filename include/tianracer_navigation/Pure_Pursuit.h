...
public:
    ...
    void mapCallback(const nav_msgs::Odometry::ConstPtr &odomMsg);
    ...
    geometry_msgs::Point get_map_car2WayPtVec(const geometry_msgs::Pose& carPose);
...
private:
    ...
    ros::Publisher ackermann_pub_, marker_pub_, plan_pub_,twist_pub_; //--------
    ros::Timer timer1, timer2;
    tf::TransformListener tf_listener_;
    tf::StampedTransform transform_;
    visualization_msgs::Marker points_, line_strip_, goal_circle_;
    geometry_msgs::Point odom_goal_pos_,  map_goal_pos_,goal_pos_;
    ackermann_msgs::AckermannDriveStamped ackermann_cmd_;
//--------
    geometry_msgs::Twist twist_cmd_ ;

    nav_msgs::Odometry odom_;
    nav_msgs::Odometry map_;
